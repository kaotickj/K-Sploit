...
Relax... it's not an error, it's a suggestion.  If you would like a graphical interface to select files for injection, install "dialog" (https://pkg.kali.org/pkg/dialog).  Otherwise, you can just type the full pathe to the exed you want to inject (i.e., /home/user/pre-male-exes/putty.exe) and hit "enter"
